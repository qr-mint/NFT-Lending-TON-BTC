...
import { TonClient, WalletContract, WalletV4Source, contractAddress, SendMode } from "ton";
...
async function main() {
  ...
  const deployerWalletType = "org.ton.wallets.v4.r2"; // also see WalletV3R2Source class used below
